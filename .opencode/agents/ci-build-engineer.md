...
2. Make minimal operational edits. Keep Node/npm application tooling separate from configuration-local Bun dependencies and Python merge tooling. Pin approved dependencies, use frozen locks and disable unapproved lifecycle scripts; no global upgrades. Retain actual VSIX assets while excluding development tooling and secrets.
